...
if(isset($_POST["submit"])=="submit")
{
            ...
            $folder = "./productUpload/". $filename;
            echo $folder;

            move_uploaded_file($tempname,$folder);


            $q1= "INSERT INTO product (product_type,product_name,product_des,product_cost,product_img,dates) VALUES ('$type','$name','$description','$cost','$filename','$dt')";
