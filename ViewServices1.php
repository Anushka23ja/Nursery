...
<li><a href="ViewServices.php">back</a></li>
...
<font size="3">
            <table align="center">
			<h1><center><u> view Services</u></center></h1>
			<?php
					...
					$q="select * from services where dates='$dt'";
					...
					//if(mysql_num_rows($res)>0)
						if($rs -> num_rows > 0)
						{
								...
								<td align='center'
								style='width:240px;height:40px;font size:18px;font-weight:bold'>Descriptiop</td>
								
								<td align='center'
								style='width:240px;height:40px;font size:18px;font-weight:bold'>Upload Image</td>
					...
					echo"<td align='center'
					style='height:20px;font-size:14px;'>".$row['service_name']."</td>";
					echo"<td align='center'
					style='height:20px;font-size:14px;'>".$row['service_dse']."</td>";
					echo"<td align='center'
					style=height:20px;font-size:14px;'> <img src='./serviceUpload/".$row['upload']."'></td>";
					...
					echo "</form>";
							...
							echo "There is No Services Record..!!";
