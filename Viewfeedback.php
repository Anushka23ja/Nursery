    ...
    <div class="container_12">
      ...
      <!--  <h3>Employee</h3>-->
        <div class="extra_wrapper">
		  ...
		  <form id="form5" name="form5" method="post" action="Viewfeedback1.php"  class="style1">
		  <br/>
...
<table width="521" border="3" align="center" bgcolor="#FFFFFF">
  <tr>
    ...
    <td width="208" align="center"><input id="txt_dt" name="txt_dt" type="date" border="2"  />
	<img onClick="javascript:NewCssCal ('txt_dt','ddMMyyyy')"/>
	</td>
