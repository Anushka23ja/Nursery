...
<li><a href="ViewDealer.php">back</a></li>
...
<font size="3">
            <table align="center">
			<h1><center><u> view Dealer</u></center></h1>
			<?php
					...
					$q="select * from dealer where dates='$dt'";
					...
					//if(mysql_num_rows($res)>0)
						if($rs -> num_rows > 0)
						{
								...
								<td align='center'
								style='width:240px;height:40px;font size:18px;font-weight:bold'>Product</td>
					...
					echo"<td align='center'
					style='height:20px;font-size:14px;'>".$row['dealer_name']."</td>";
					echo"<td align='center'
					style='height:20px;font-size:14px;'>".$row['dealer_add']."</td>";
					echo"<td align='center'
					style=height:20px;font-size:14px;'>".$row['dealer_mob']."</td>";
					echo"<td align='center'
					style='height:20px;font-size:14px;'>".$row['dealer_email']."</td>";
					echo"<td align='center'
					style='height:20px;font-size:14px;'>".$row['dealer_product']."</td>";
					...
					echo "</form>";
							...
							echo "There is No Dealer Record..!!";
