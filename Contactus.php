      ...
      <!--  <div class="autor"> <a href="#">User Login</a> Social </div>-->
        <nav>
          <ul class="sf-menu">
            ...
            <li class="current"><a href="contacts.html">Contacts</a>
    ...
    <div class="container_12">
      <div class="grid_8">
        <h3> Contact Information</h3>
		      <div class="text2"> Plant Nursery </div>
		  If you have any query - be it with regards to purchasing a plant or a garden tool; garden consultancy or maintenance; landscaping or farm management; tree transplantation, or if you want to be our franchisee, you can get in touch with us, and we will be happy to be at your service. 
		  <br>
		  <br>
          <address>
          <dl>
		...
		<center> <div class="style44"> <form method="post"   action="feedback.php">
			...
			<table width="795" height="442"  cellpadding="4" cellspacing="4" >
			<br/>
			<tr>
			<td width="214" height="56"><span class="style1">Full Name: </span></td>
			<td width="496"><input name="nm" class="style1" type="text" id="nm" size="35" placeholder="Enter Fullname starting with Surname..."/></td>
			</tr>
			<tr>
			  <td height="48"><span class="style1">Email-Id :</span></td>
			  <td><input name="email" class="style1" type="text" id="email" size="35" placeholder="For Eg: abc@gmail.com" /></td>
			</tr>
			<tr>
			...
			<td><textarea name="feedback" class="style1" rows="5" cols="50" id="feedback" placeholder="Enter your Comments here..." onKeyUp="LimtCharacters(this,250,'lblcount');"></textarea>
			<br>
