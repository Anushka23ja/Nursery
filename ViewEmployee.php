    ...
    <div class="container_12">
      ...
      <!--  <h3>Employee</h3>-->
        <div class="extra_wrapper">
		  ...
		  <form id="form5" name="form5" method="post" action="ViewEmployee1.php" class="style1">EMPLOYEE
...
<table width="521" border="3" align="center" bgcolor="#FFFFFF">
  <tr>
	...
	<td width="167" align="center">&nbsp;
	  <label>
        <input  type="submit"  class="btn btn-success " name="Submit" value="View" style="font-size:20px;font-weight:bold;width:100px;" style="border:double;  " onClick="return valid();" />
