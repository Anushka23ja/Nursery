...
function valid()
{
  var Position=document.getElementById("nm").value;
  var Qulification=document.getElementById("qul").value;
  var Experience=document.getElementById("exp").value; 
  var Job Location=document.getElementById("jl").value;
  var Job Profile=document.getElementById("jp").value;
      ...
      <div class="grid_12">
        ...
        <nav>
		   ...
		   <li><a href="">Dealer</a>
			...
			<li class="current"><a href="AdminCareer.php">Career</a>
			 <!--<ul>
    ...
    <div class="container_12">
      ...
      <!--  <h3>Employee</h3>-->
        <div class="extra_wrapper">
		  ...
		  <center><form method="post" action="Careerquery.php"  class="style1"><h1><b><font color="#000000">Career </font></b></h1>
<table width="625" height="450" border="4" cellpadding="4"  cellspacing="4"  >
<tr>
<td width="187" height="66"><b><i>Position:</i></b></td>
<td width="398"> <input name="nm" type="text" class="style1" id="nm"  size="30" placeholder=""/> </td>
</tr>
<br/>

<tr>
<td><b><i>Qulification:</i></b></td>
<td><input name="qul" type="text"  class="style1" id="qul" size="30" placeholder="" /></td> 
</tr>

<tr>
<td><b><i>Experience:</i></b> </td>
<td><input name="exp" type="text" class="style1"id="exp" size="30" placeholder=""/></td>
</tr>

<tr>
<td><b><i>Job Location:</i></b></td>
<td> <input name="jl" type="text" class="style1" id="jl" size="30" placeholder="" /></td>
</tr>
<tr>
<td><b><i>Job Profile:</i></b></td>
<td><input name="jp" type="text"  class="style1" id="jp" size="30" placeholder="" /></td> 
</tr>
