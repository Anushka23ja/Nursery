...
<header>
  ...
  <ul class="sf-menu">
            <li ><a href="index.html">Home</a></li>
			 ...
			 <li class="current"><a href="Employee.php">Employee</a>
	        <!-- <ul>
		   ...
		   <li><a href="Dealer.php">Dealer</a>
			...
			<li><a href="AdminCareer.php">Career</a>
			 <ul>
    ...
    <div class="container_12">
      ...
      <!--  <h3>Employee</h3>-->
        <div class="extra_wrapper">
		  ...
		  <center><form method="post" action="Employeequery.php"  class="style1"><h1><b><font color="#000000">Employee </font></b></h1>
<table width="625" height="450" border="4" cellpadding="4"  cellspacing="4"  >
<tr>
<td width="187" height="66"><b><i>Full Name:</i></b></td>
<td width="398"> <input name="nm" type="text" class="style1" id="nm"  size="30" placeholder="Enter Your Name..."/> </td>
</tr>
<br/>

<tr>
<td><b><i>Address: </i></b></td>
<td> <input name="add" type="text" class="style1" id="add" size="30" placeholder="Enter Your Address..." /></td>
</tr>

<tr>
<td><b><i>Contact:</i></b></td>
<td> <input name="con" type="text"  class="style1" id="con" size="30" placeholder="Enter Contact Number..." /></td>
</tr>


<tr>
<td><b><i>Email-Id:</i></b></td>
<td> <input name="eid" type="text" class="style1" id="eid" size="30" placeholder="Enter Your email..." /></td>
</tr>
<tr>
<td><b><i>Qulification:</i></b></td>
<td><input name="qul" type="text"  class="style1" id="qul" size="30" placeholder="Enter Your Qulaification" /></td> 
</tr>
<tr>
<td><b><i>Designation:</i></b></td>
<td><input name="post" type="text" class="style1" id="post" size="30" placeholder="Enter Your Designation.." /></td> 
</tr>
<tr>
<td><b><i>Experience:</i></b> </td>
<td><input name="exp" type="text" class="style1"id="exp" size="30" placeholder="Enter Your Experience..."/></td>
</tr>
...
<td >   <input type="Submit" class="btn btn-success " name="submit"  onclick="return valid()" value="ADD" /></td>
