        ...
        <nav>
           ...
           <li ><a href="UserIndex.php">Home</a></li>
            ...
            <li ><a href="UserProduct.html">Plants</a></li>
             ...
             <li class="current"><a href="UserEnquiry.php">Enquiry</a>
  ...
  <div class="white wt2">
    <div class="container_12">
      <div class="grid_8">
		...
		<center> <div class="style44"> <form method="post"   action="UserEnquiryquery.php">

			<table width="750" height="450"  cellpadding="4" cellspacing="4" >
			<br/>
			<tr>
			<td width="214" height="56"><span class="style1">Full Name: </span></td>
			<td width="496"><input name="nm" class="style1" type="text" id="nm" size="30" placeholder="Enter Your Name..."/></td>
			</tr>
			<tr>
			  <td height="48"><span class="style1">Email-Id :</span></td>
			  <td><input name="email" class="style1" type="text" id="email" size="30" placeholder="Enter Your Email..." /></td>
			</tr>
			<tr>
			<td height="57"><span class="style1">Contact Number :</span></td>
			<td><input name="contact"  class="style1" type="text" id="contact" size="30" placeholder="Enter Contact Number..."  /></td>
			</tr>
			<tr>
			<td height="120"><span class="style1">Message:</span> </td>
			<td><textarea name="feedback" class="style1" rows="5" cols="30" id="feedback" placeholder="Enter your Comments here..." onKeyUp="LimtCharacters(this,250,'lblcount');"></textarea>
			<br>
