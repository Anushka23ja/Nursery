    ...
    <div class="container_12">
      ...
      <!--  <h3>Employee</h3>-->
        <div class="extra_wrapper">
		  ...
		  <center><form method="post" action="Servicesquery.php"  enctype="multipart/form-data"  class="style1"><h1><b><font color="#000000">Services </font></b></h1>
<table width="525" height="359" border="4" cellpadding="4"  cellspacing="4"  >
<tr>
<td width="196" height="57"><b><i>Name:</i></b></td>
<td width="250"> <input name="nm" type="text" class="style1" id="nm"  size="30" placeholder="Enter Service Name..."/> </td>
</tr>
<br/>
...
<tr>
<td height="60" ><b><i>Description:</i></b></td>
<td><input type="text" id="des" name="des" class="style1"  size="30" placeholder="Enter Service Description..." /></td>
</tr>
...
<tr>
<td height="69" ><b><i>Upload Image:</i></b></td>
